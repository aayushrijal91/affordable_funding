<footer>
	<div class="container">
		<div class="row">
			<div class="col-lg-7">
				<div class="row">
					<div class="col-12 fs-2 fw-700 line-height-3">Fast, Simple, and Affordable Funding, when you need it!</div>
					<div class="col-lg-8 line-height-2 fs-8">Apply Online or over the Phone in less than 5 minutes, and work our magic, and handle the rest!</div>
				...
				<div class="row justify-content-between">
					<div class="col-3">
						...
						<div class="row align-items-center gx-3 pt-4">
							...
							<div class="col-auto"><a href=""><?= renderImg("facebook.png", "icons", "social-icon") ?></a></div>
							<div class="col-auto"><a href=""><?= renderImg("instagram.png", "icons", "social-icon") ?></a></div>
							<div class="col-auto"><a href=""><?= renderImg("linkedin.png", "icons", "social-icon") ?></a></div>
							<div class="col-auto"><a href=""><?= renderImg("gmb.png", "icons", "social-icon") ?></a></div>
					...
					<div class="col-4">
						...
						<div class="row justify-content-between align-items-center py-4">
							<div class="col-auto"><?= renderImg("afca.png", "logo") ?></div>
							<div class="col-auto"><?= renderImg("fintelligence.png", "logo") ?></div>
							<div class="col-auto"><?= renderImg("fbaa.png", "logo") ?></div>
						</div>
			...
			<div class="row">
				<div class="col-xl-7">
					<div class="row justify-content-between align-items-center fw-300 py-4">
